...
class Defaults(object):
    ...
    default_host_profile = (
        f"conan/profiles/{system}.{default_build_types.lower()}.{current_architecture}"
    )
    default_package_host_profile = (
        f"conan/profiles/{system}.{release_build_type.lower()}.{current_architecture}"
    )
    default_build_profile = f"conan/profiles/{system}.default"
